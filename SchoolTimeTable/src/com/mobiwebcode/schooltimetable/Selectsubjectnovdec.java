...
import com.mobiwebcode.schooltimetable.SelectWschesubject.CustomList;
import com.mobiwebcode.schooltimetable.SelectWschesubject.myTask_WasschesubjectList_call;
...
public class Selectsubjectnovdec extends Activity implements
		OnItemClickListener {
	ListView listView;
	ArrayList<NovDecSubjectVo> subjectlist = new ArrayList<NovDecSubjectVo>();
	String responseString = null;
	XMLParser parser = new XMLParser();
	String xml = "";
	NodeList nl;
	Document doc;
	String NOVDEC_SUBJECT_URL = "http://millionairesorg.com/schooltimetable/timetablesubjects.php";
	CustomList adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.selectsubjectnovdec);
			...
			public void onClick(View v) {
...

				{
					if (adapter.mCheckStates.get(i) == true) {
						NovDecSubjectVo nsVo = (NovDecSubjectVo) subjectlist
								.get(i);
						selectedsubject = selectedsubject + "'"
								+ (nsVo.subjectname.replace(" ", "_")) + "'";
						selectedsubject = selectedsubject + ",";
					}
				...
				NovDecActivity.isSave = true;
				Intent myintent2 = new Intent(Selectsubjectnovdec.this,
						NovDecActivity.class);
				startActivity(myintent2);

			}
		});
		new myTask_NovDecsubjectList_call().execute();
	}

	// DownloadJSON AsyncTask for activityDetails
	class myTask_NovDecsubjectList_call extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String str_resp) {
			...
			xml = parser.getXmlFromUrl(NOVDEC_SUBJECT_URL);
			...
			if (doc != null) {
				...
				for (int i = 0; i < nl.getLength(); i++) {
					...
					NovDecSubjectVo slVo = new NovDecSubjectVo();
			...
			adapter = new CustomList(Selectsubjectnovdec.this, subjectlist);
	...
	public class CustomList extends BaseAdapter implements
		...
		ArrayList<NovDecSubjectVo> adapterTimetableList;
		TextView novdecsubjectTextView;
		CheckBox checkbox;
		public SparseBooleanArray mCheckStates;

		public CustomList(Activity context,
				ArrayList<NovDecSubjectVo> mainTimetableList_) {
		...
		public View getView(final int position, final View view,
			...
			View rowView = inflater.inflate(
					R.layout.selectsubjectnovdec_iteminfo, null, true);
			NovDecSubjectVo nsVo = subjectlist.get(position);
			novdecsubjectTextView = (TextView) rowView
					.findViewById(R.id.Subject);
			novdecsubjectTextView.setText(nsVo.subjectname);
